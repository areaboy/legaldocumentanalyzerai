...
$docs_id= strip_tags($_POST['docs_id']);
$docs_identity= strip_tags($_POST['docs_identity']);


$documents_id= strip_tags($_POST['docs_id']);
$documents_time= strip_tags($_POST['docs_identity']);
...
$text_prompt= "Here is the text $message . Give me all the important keywords, Keyphrases and Entities from the text seperated by hyphen";
...
echo "<div style='color:white;background:green;padding:10px;'><b>Document Keywords, Keyphrases and Entities Analysis Via ChatGPT Successful.</b></div><br>";
