...
$text_prompt= "Give me sentiments analysis of  text '$message' seperated by hyphen";
...
echo "<div style='color:white;background:green;padding:10px;'><b>Document Sentiments Analysis Via ChatGPT Successful.</b></div><br>";
