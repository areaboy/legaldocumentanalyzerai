...
$text_prompt= "Give me summary of  text '$message' in seven sentences each seperated by hyphen";
...
echo "<div style='color:white;background:green;padding:10px;'><b>Document Summary Analysis Via ChatGPT Successful.</b></div><br>";
...
echo $res = "<div class='cssxx'>".str_replace('-', "</div><div class='cssxx'>", $val)."</div>";
