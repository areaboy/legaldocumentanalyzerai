...
$logo = 'logo.png';
$title = 'Openshift & ChatGPT Legal Contract Documents Analyzer';
$description = 'An AI Tools that help Businesses, Companies etc. to Simplify, Analyze, Summarize and  Translate Legal Contract Documents leveraging Openshift Technologies and ChatGPT AI </b>';

$header_color = 'purple';
$header_color2 = 'purple';
$footer_color = 'black';
$site_display = 'Openshift Legal Contract Documents Analyzer';
...
.left-column-all {
    ...
    width:50vw;
    height: 100vh;
    background: url(home1a.png) center no-repeat <?php echo $header_color; ?>;
...
$('#loader_signup').fadeIn(400).html('<br><div style="color:black;background:#ddd;padding:10px;"><img src="ajax-loader.gif"> Please Wait! .User is being Created...</div>')
...
<br>
 ...
 <div class="form-group">
                    ...
                    <input type="button" id="signup_btnx" class="pull-right btn btn-primary signup_btnx" value="Create User" />
...
<marquee> <p class=""><button class="contact_click marquee_button"><img class="marquee_image" src="home1a.png" /><?php echo $title; ?></button> </p></marquee>
...
<a  class="category_post" data-toggle="modal" data-target="#myModal_signup_staff">Signup</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<a  class="category_post" data-toggle="modal" data-target="#myModal_login">Login</a>
...
<br><br>
<img style="width:100%;min-width:100%;max-width:100%;height:400px;" src="home2a.png">
