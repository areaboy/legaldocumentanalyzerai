...
if($question == ''){
echo "<div style='background:red;color:white;padding:10px;border:none;'>Please Enter ChatGPT Question you want to Ask</div><br>";
exit();
}
...
echo "<div style='color:white;background:green;padding:10px;'><b>Answer successfully Generated by ChatGPT.</b></div><br>";
